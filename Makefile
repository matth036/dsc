...
#
# CPPSRC+=$(AA_SRCDIR)
CPPSRC+=$(AA_SRCDIR)/AAVSOP87.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87A_EAR.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87A_EMB.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87A_JUP.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87A_MAR.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87A_MER.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87A_NEP.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87A_SAT.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87A_URA.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87A_VEN.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87B_EAR.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87B_JUP.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87B_MAR.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87B_MER.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87B_NEP.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87B_SAT.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87B_URA.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87B_VEN.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87C_EAR.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87C_JUP.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87C_MAR.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87C_MER.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87C_NEP.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87C_SAT.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87C_URA.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87C_VEN.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87D_EAR.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87D_JUP.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87D_MAR.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87D_MER.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87D_NEP.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87D_SAT.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87D_URA.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87D_VEN.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87E_EAR.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87E_JUP.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87E_MAR.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87E_MER.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87E_NEP.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87E_SAT.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87E_SUN.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87E_URA.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87E_VEN.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87_EMB.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87_JUP.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87_MAR.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87_MER.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87_NEP.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87_SAT.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87_URA.cpp
CPPSRC+=$(AA_SRCDIR)/AAVSOP87_VEN.cpp
...
#
# See documentation aa.html for version 1.63 (16 September 2015) of Naughter's source.
